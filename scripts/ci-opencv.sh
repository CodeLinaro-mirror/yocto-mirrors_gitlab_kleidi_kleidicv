...
IMGPROC_TEST_PATTERNS=(
  ...
  '*Imgproc_cvtColor_BE.COLOR_RGB2YUV_YV12'
  '*Imgproc_cvtColor_BE.COLOR_BGR2YUV_YV12'
  '*Imgproc_cvtColor_BE.COLOR_RGBA2YUV_YV12'
  '*Imgproc_cvtColor_BE.COLOR_BGRA2YUV_YV12'
  '*Imgproc_Threshold*'
  '*Imgproc_Morphology*'
