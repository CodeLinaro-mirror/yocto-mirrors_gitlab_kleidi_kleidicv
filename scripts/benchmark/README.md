...
Also, the OpenCV 4.14.0 source needs to be downloaded and patched. Assuming CWD is the root of OpenCV's
source directory please run:
```
patch -p1 < path/to/kleidicv/adapters/opencv/opencv-4.14.patch
patch -p1 < path/to/kleidicv/adapters/opencv/extra_benchmarks/opencv-4.14.patch
```
