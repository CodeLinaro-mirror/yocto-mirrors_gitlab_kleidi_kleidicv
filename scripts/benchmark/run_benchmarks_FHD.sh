...
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL GRAY2BGR opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_GRAY2BGR)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL GRAY2BGRA opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_GRAY2BGRA)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGR2RGB opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGR2RGB)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGRA2RGBA opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGRA2RGBA)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGR2RGBA opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGR2RGBA)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGR2BGRA opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGR2BGRA)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL RGBA2BGR opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_RGBA2BGR)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGRA2BGR opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGRA2BGR)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL YUVSP2BGR opencv_perf_imgproc '*cvtColorYUV420/*' '(1920x1080, COLOR_YUV2BGR_NV12)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL YUVSP2BGRA opencv_perf_imgproc '*cvtColorYUV420/*' '(1920x1080, COLOR_YUV2BGRA_NV12)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL YUVSP2RGB opencv_perf_imgproc '*cvtColorYUV420/*' '(1920x1080, COLOR_YUV2RGB_NV12)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL YUVSP2RGBA opencv_perf_imgproc '*cvtColorYUV420/*' '(1920x1080, COLOR_YUV2RGBA_NV12)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL RGB2YUV opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_RGB2YUV)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL BGR2YUV opencv_perf_imgproc '*cvtColor8u/*' '(1920x1080, COLOR_BGR2YUV)')")
...
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL SepFilter2D_5x5 opencv_perf_imgproc '*KleidiCV_SepFilter2D.SepFilter2D/*' '(1920x1080, 8UC1, 5, BORDER_REPLICATE)')")
...
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL GaussianBlur5x5 opencv_perf_imgproc '*gaussianBlur5x5/*' '(1920x1080, 8UC1, BORDER_REPLICATE)')")
...
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Sobel_Gx opencv_perf_imgproc '*Border3x3_sobelFilter.sobelFilter/*' '(1920x1080, 16SC1, (1, 0), BORDER_REPLICATE)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Sobel_Gy opencv_perf_imgproc '*Border3x3_sobelFilter.sobelFilter/*' '(1920x1080, 16SC1, (0, 1), BORDER_REPLICATE)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Dilate3x3 opencv_perf_imgproc '*Dilate_big.big/*' '(1920x1080, 8UC1, 3)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Dilate5x5 opencv_perf_imgproc '*Dilate_big.big/*' '(1920x1080, 8UC1, 5)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Dilate17x17 opencv_perf_imgproc '*Dilate_big.big/*' '(1920x1080, 8UC1, 17)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Erode3x3 opencv_perf_imgproc '*Erode_big.big/*' '(1920x1080, 8UC1, 3)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Erode5x5 opencv_perf_imgproc '*Erode_big.big/*' '(1920x1080, 8UC1, 5)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Erode17x17 opencv_perf_imgproc '*Erode_big.big/*' '(1920x1080, 8UC1, 17)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Resize_0.5_8b opencv_perf_imgproc '*ResizeAreaFast/*' '(8UC1, 1920x1080, 2)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL Resize2x2_8b opencv_perf_imgproc '*resizeUpLinearNonExact/*' '(8UC1, (960x540, 1920x1080))')")
...
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL MinMaxLoc_U8_FHD opencv_perf_core '*minMaxLoc/*' '(1920x1080, 8UC1)')")

RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL FloatToInt opencv_perf_core '*convertTo/*' '(1920x1080, 32FC1, 8SC1, 1, 1, 0)')")
RES+=$(printf "\n$(${DEV_DIR}/perf_test_op.sh $CUSTOM_BUILD_SUFFIX $CPU $THERMAL FloatToUint opencv_perf_core '*convertTo/*' '(1920x1080, 32FC1, 8UC1, 1, 1, 0)')")
