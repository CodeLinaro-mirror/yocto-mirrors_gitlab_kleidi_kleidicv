...
Note: For uint8 downsize and upsize, table specifies horizontal scaling. Vertical scaling factor is independent, it can be anything, even vertical upsizing is supported when the horizontal dimension is downsized.
