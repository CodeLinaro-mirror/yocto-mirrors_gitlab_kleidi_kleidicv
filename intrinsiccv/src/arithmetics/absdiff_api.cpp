...
INTRINSICCV_DEFINE_C_API(saturating_absdiff_u8, uint8_t);
INTRINSICCV_DEFINE_C_API(saturating_absdiff_s8, int8_t);
INTRINSICCV_DEFINE_C_API(saturating_absdiff_u16, uint16_t);
INTRINSICCV_DEFINE_C_API(saturating_absdiff_s16, int16_t);
INTRINSICCV_DEFINE_C_API(saturating_absdiff_s32, int32_t);
