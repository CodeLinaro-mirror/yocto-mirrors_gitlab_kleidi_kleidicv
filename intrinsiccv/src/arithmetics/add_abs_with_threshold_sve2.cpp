...
template <typename T>
INTRINSICCV_TARGET_FN_ATTRS intrinsiccv_error_t add_abs_with_threshold(
  ...
  return add_abs_with_threshold_sc(src_a, src_a_stride, src_b, src_b_stride,
                                   dst, dst_stride, width, height, threshold);
}
