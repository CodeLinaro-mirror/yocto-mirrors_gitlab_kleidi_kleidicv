...
void yuv_sp_to_rgb_u8(const uint8_t *src_y, size_t src_y_stride,
                      ...
                      bool is_nv21) {
  yuv_sp_to_rgb_u8_sc(src_y, src_y_stride, src_uv, src_uv_stride, dst,
...
void yuv_sp_to_rgba_u8(const uint8_t *src_y, size_t src_y_stride,
  ...
  yuv_sp_to_rgba_u8_sc(src_y, src_y_stride, src_uv, src_uv_stride, dst,
                       dst_stride, width, height, is_nv21);
}
...
void yuv_sp_to_bgr_u8(const uint8_t *src_y, size_t src_y_stride,
                      ...
                      size_t dst_stride, size_t width, size_t height,
                      bool is_nv21) {
  yuv_sp_to_bgr_u8_sc(src_y, src_y_stride, src_uv, src_uv_stride, dst,
                      dst_stride, width, height, is_nv21);
}
...
void yuv_sp_to_bgra_u8(const uint8_t *src_y, size_t src_y_stride,
                       ...
                       uint8_t *dst, size_t dst_stride, size_t width,
                       size_t height, bool is_nv21) {
  yuv_sp_to_bgra_u8_sc(src_y, src_y_stride, src_uv, src_uv_stride, dst,
                       dst_stride, width, height, is_nv21);
}
