...
KLEIDICV_DEFINE_C_API(intrinsiccv_float_conversion_f32_s8, float, int8_t);
KLEIDICV_DEFINE_C_API(intrinsiccv_float_conversion_f32_u8, float, uint8_t);
KLEIDICV_DEFINE_C_API(intrinsiccv_float_conversion_s8_f32, int8_t, float);
KLEIDICV_DEFINE_C_API(intrinsiccv_float_conversion_u8_f32, uint8_t, float);
