...
static void separable_filter_2d_f32_5x5_1ch(benchmark::State& state) {
  separable_filter_2d<float, 5, 1>(state, kleidicv_separable_filter_2d_f32);
}
BENCHMARK(separable_filter_2d_f32_5x5_1ch);

static void separable_filter_2d_f32_5x5_3ch(benchmark::State& state) {
  separable_filter_2d<float, 5, 3>(state, kleidicv_separable_filter_2d_f32);
}
BENCHMARK(separable_filter_2d_f32_5x5_3ch);
