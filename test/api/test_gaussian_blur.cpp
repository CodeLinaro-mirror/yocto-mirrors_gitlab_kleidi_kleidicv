...
static constexpr size_t kToleranceTwo = 2;
static constexpr size_t kToleranceThree = 3;
...
TYPED_TEST(GaussianBlur, 7x7) {
  ...
  // clang-format on
  GaussianBlurTest{KernelTestParams{}, test::small_array_layouts, kAllBorders,
                   kToleranceThree}
      .test(mask);
}
