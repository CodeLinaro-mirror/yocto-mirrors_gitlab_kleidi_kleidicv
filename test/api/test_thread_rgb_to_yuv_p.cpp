...
TEST_P(RgbToYuv420Thread, FromBGR) {
  check(kleidicv_bgr_to_yuv420_p_u8, kleidicv_thread_bgr_to_yuv420_p_u8, 3);
}
TEST_P(RgbToYuv420Thread, FromBGRA) {
  check(kleidicv_bgra_to_yuv420_p_u8, kleidicv_thread_bgra_to_yuv420_p_u8, 4);
}
TEST_P(RgbToYuv420Thread, FromRGB) {
  check(kleidicv_rgb_to_yuv420_p_u8, kleidicv_thread_rgb_to_yuv420_p_u8, 3);
}
TEST_P(RgbToYuv420Thread, FromRGBA) {
  check(kleidicv_rgba_to_yuv420_p_u8, kleidicv_thread_rgba_to_yuv420_p_u8, 4);
}
