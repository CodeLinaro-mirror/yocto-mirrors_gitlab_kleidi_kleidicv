...
enum {
  ...
  THRESHOLD_TRANSPOSE_ROTATE_U64 = 10000,
  THRESHOLD_TRANSPOSE_ROTATE_U24 = 2000,
  THRESHOLD_TRANSPOSE_ROTATE_U48 = 2000
};
...
int transpose(const uchar *src_data, size_t src_step, uchar *dst_data,
  ...
  switch (element_size) {
    case sizeof(uint64_t):
      min_elements = THRESHOLD_TRANSPOSE_ROTATE_U64;
      break;
    case sizeof(uint8_t) * 3:
      min_elements = THRESHOLD_TRANSPOSE_ROTATE_U24;
      break;
    case sizeof(uint16_t) * 3:
      min_elements = THRESHOLD_TRANSPOSE_ROTATE_U48;
      break;
    default:
      min_elements = 0;
  }
