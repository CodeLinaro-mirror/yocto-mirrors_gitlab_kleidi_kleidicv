...
#define KLEIDICV_HAL_API(api) (intrinsiccv::hal::api)
...
#define KLEIDICV_HAL_FALLBACK_FORWARD(intrinsiccv_impl, fallback_hal_impl, \
                                      ...)                                 \
  (KLEIDICV_HAL_API(intrinsiccv_impl)(__VA_ARGS__) == CV_HAL_ERROR_OK      \
       ? CV_HAL_ERROR_OK                                                   \
