...
separable_filter_2d_u8(const uint8_t *src, size_t src_stride, uint8_t *dst,
  ...
  return separable_filter_2d_u8_sc(
      src, src_stride, dst, dst_stride, width, height, channels, kernel_x,
      kernel_width, kernel_y, kernel_height, border_type, context);
}
