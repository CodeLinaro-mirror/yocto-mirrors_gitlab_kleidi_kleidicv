...
rgb_to_yuv420_sp_stripe_u8(const uint8_t *src, size_t src_stride,
                           uint8_t *y_dst, size_t y_stride, uint8_t *uv_dst,
                           size_t uv_stride, size_t width, size_t height,
                           bool is_nv21, size_t begin, size_t end) {
...
KLEIDICV_LOCALLY_STREAMING KLEIDICV_TARGET_FN_ATTRS kleidicv_error_t
rgba_to_yuv420_sp_stripe_u8(const uint8_t *src, size_t src_stride,
                            uint8_t *y_dst, size_t y_stride, uint8_t *uv_dst,
                            size_t uv_stride, size_t width, size_t height,
                            bool is_nv21, size_t begin, size_t end) {
  CHECK_POINTER_AND_STRIDE(src, src_stride, height);
...
KLEIDICV_LOCALLY_STREAMING KLEIDICV_TARGET_FN_ATTRS kleidicv_error_t
bgr_to_yuv420_sp_stripe_u8(const uint8_t *src, size_t src_stride,
                           uint8_t *y_dst, size_t y_stride, uint8_t *uv_dst,
                           size_t uv_stride, size_t width, size_t height,
                           bool is_nv21, size_t begin, size_t end) {
  CHECK_POINTER_AND_STRIDE(src, src_stride, height);
...
KLEIDICV_LOCALLY_STREAMING KLEIDICV_TARGET_FN_ATTRS kleidicv_error_t
bgra_to_yuv420_sp_stripe_u8(const uint8_t *src, size_t src_stride,
                            uint8_t *y_dst, size_t y_stride, uint8_t *uv_dst,
                            size_t uv_stride, size_t width, size_t height,
                            bool is_nv21, size_t begin, size_t end) {
  CHECK_POINTER_AND_STRIDE(src, src_stride, height);
