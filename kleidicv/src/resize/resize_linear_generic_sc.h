...
#define KLEIDICV_INSTANTIATE_TEMPLATE_SC(ratio, channels, up)        \
  template kleidicv_error_t                                          \
  kleidicv_resize_generic_stripe_u8_sc<ratio, channels, up>(         \
...
KLEIDICV_INSTANTIATE_TEMPLATE_SC(1, 1, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(1, 2, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(1, 3, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 1, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 2, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 3, true);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 1, false);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 2, false);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(2, 3, false);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(3, 1, false);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(3, 2, false);
KLEIDICV_INSTANTIATE_TEMPLATE_SC(3, 3, false);
