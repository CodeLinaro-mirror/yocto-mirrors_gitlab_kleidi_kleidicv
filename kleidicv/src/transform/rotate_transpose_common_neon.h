...
template <typename ScalarType, bool k3Channels, typename StoreFn>
...
// tails.
template <typename ScalarType, bool k3Channels, bool kReverseRows,
...
static inline kleidicv_error_t rotate_transpose_rect(
  ...
  const auto rotate_scalar_segment = [&](size_t vindex, size_t hindex,
    ...
    rotate_transpose_scalar<ScalarType, k3Channels>(
