...
#ifndef KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_3X3_H
#define KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_3X3_H
...
class SeparableFilterLoader3x3 {
 public:
...
#endif  // KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_3X3_H
