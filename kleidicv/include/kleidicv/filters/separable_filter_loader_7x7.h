...
#ifndef KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_7X7_H
#define KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_7X7_H
...
class SeparableFilterLoader7x7 {
 public:
...
#endif  // KLEIDICV_FILTER_SEPARABLE_FILTER_LOADER_7X7_H
