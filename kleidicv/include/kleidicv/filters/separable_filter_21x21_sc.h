...
class SeparableFilter<FilterType, 21UL> {
 ...
 private:
  ...
  void horizontal_vector_path_2x(svbool_t pg, Rows<const BufferType> src_rows,
    ...
    auto src_row_7 = &src_rows.at(0, border_offsets.c7())[index];
    auto src_row_8 = &src_rows.at(0, border_offsets.c8())[index];
    auto src_row_9 = &src_rows.at(0, border_offsets.c9())[index];
    auto src_row_10 = &src_rows.at(0, border_offsets.c10())[index];
    auto src_row_11 = &src_rows.at(0, border_offsets.c11())[index];
    auto src_row_12 = &src_rows.at(0, border_offsets.c12())[index];
    auto src_row_13 = &src_rows.at(0, border_offsets.c13())[index];
    auto src_row_14 = &src_rows.at(0, border_offsets.c14())[index];
    auto src_row_15 = &src_rows.at(0, border_offsets.c15())[index];
    auto src_row_16 = &src_rows.at(0, border_offsets.c16())[index];
    auto src_row_17 = &src_rows.at(0, border_offsets.c17())[index];
    auto src_row_18 = &src_rows.at(0, border_offsets.c18())[index];
    auto src_row_19 = &src_rows.at(0, border_offsets.c19())[index];
    auto src_row_20 = &src_rows.at(0, border_offsets.c20())[index];
    ...
    auto src_7 = svld1_x2(pg_counter, &src_row_7[0]);
    auto src_8 = svld1_x2(pg_counter, &src_row_8[0]);
    auto src_9 = svld1_x2(pg_counter, &src_row_9[0]);
    auto src_10 = svld1_x2(pg_counter, &src_row_10[0]);
    auto src_11 = svld1_x2(pg_counter, &src_row_11[0]);
    auto src_12 = svld1_x2(pg_counter, &src_row_12[0]);
    auto src_13 = svld1_x2(pg_counter, &src_row_13[0]);
    auto src_14 = svld1_x2(pg_counter, &src_row_14[0]);
    auto src_15 = svld1_x2(pg_counter, &src_row_15[0]);
    auto src_16 = svld1_x2(pg_counter, &src_row_16[0]);
    auto src_17 = svld1_x2(pg_counter, &src_row_17[0]);
    auto src_18 = svld1_x2(pg_counter, &src_row_18[0]);
    auto src_19 = svld1_x2(pg_counter, &src_row_19[0]);
    auto src_20 = svld1_x2(pg_counter, &src_row_20[0]);
    ...
    BufferVectorType src_0_7 = svget2(src_7, 0);
    BufferVectorType src_1_7 = svget2(src_7, 1);
    BufferVectorType src_0_8 = svget2(src_8, 0);
    BufferVectorType src_1_8 = svget2(src_8, 1);
    BufferVectorType src_0_9 = svget2(src_9, 0);
    BufferVectorType src_1_9 = svget2(src_9, 1);
    BufferVectorType src_0_10 = svget2(src_10, 0);
    BufferVectorType src_1_10 = svget2(src_10, 1);
    BufferVectorType src_0_11 = svget2(src_11, 0);
    BufferVectorType src_1_11 = svget2(src_11, 1);
    BufferVectorType src_0_12 = svget2(src_12, 0);
    BufferVectorType src_1_12 = svget2(src_12, 1);
    BufferVectorType src_0_13 = svget2(src_13, 0);
    BufferVectorType src_1_13 = svget2(src_13, 1);
    BufferVectorType src_0_14 = svget2(src_14, 0);
    BufferVectorType src_1_14 = svget2(src_14, 1);
    BufferVectorType src_0_15 = svget2(src_15, 0);
    BufferVectorType src_1_15 = svget2(src_15, 1);
    BufferVectorType src_0_16 = svget2(src_16, 0);
    BufferVectorType src_1_16 = svget2(src_16, 1);
    BufferVectorType src_0_17 = svget2(src_17, 0);
    BufferVectorType src_1_17 = svget2(src_17, 1);
    BufferVectorType src_0_18 = svget2(src_18, 0);
    BufferVectorType src_1_18 = svget2(src_18, 1);
    BufferVectorType src_0_19 = svget2(src_19, 0);
    BufferVectorType src_1_19 = svget2(src_19, 1);
    BufferVectorType src_0_20 = svget2(src_20, 0);
    BufferVectorType src_1_20 = svget2(src_20, 1);
#else
    ...
    BufferVectorType src_0_7 = svld1(pg, &src_row_7[0]);
    BufferVectorType src_1_7 = svld1_vnum(pg, &src_row_7[0], 1);
    BufferVectorType src_0_8 = svld1(pg, &src_row_8[0]);
    BufferVectorType src_1_8 = svld1_vnum(pg, &src_row_8[0], 1);
    BufferVectorType src_0_9 = svld1(pg, &src_row_9[0]);
    BufferVectorType src_1_9 = svld1_vnum(pg, &src_row_9[0], 1);
    BufferVectorType src_0_10 = svld1(pg, &src_row_10[0]);
    BufferVectorType src_1_10 = svld1_vnum(pg, &src_row_10[0], 1);
    BufferVectorType src_0_11 = svld1(pg, &src_row_11[0]);
    BufferVectorType src_1_11 = svld1_vnum(pg, &src_row_11[0], 1);
    BufferVectorType src_0_12 = svld1(pg, &src_row_12[0]);
    BufferVectorType src_1_12 = svld1_vnum(pg, &src_row_12[0], 1);
    BufferVectorType src_0_13 = svld1(pg, &src_row_13[0]);
    BufferVectorType src_1_13 = svld1_vnum(pg, &src_row_13[0], 1);
    BufferVectorType src_0_14 = svld1(pg, &src_row_14[0]);
    BufferVectorType src_1_14 = svld1_vnum(pg, &src_row_14[0], 1);
    BufferVectorType src_0_15 = svld1(pg, &src_row_15[0]);
    BufferVectorType src_1_15 = svld1_vnum(pg, &src_row_15[0], 1);
    BufferVectorType src_0_16 = svld1(pg, &src_row_16[0]);
    BufferVectorType src_1_16 = svld1_vnum(pg, &src_row_16[0], 1);
    BufferVectorType src_0_17 = svld1(pg, &src_row_17[0]);
    BufferVectorType src_1_17 = svld1_vnum(pg, &src_row_17[0], 1);
    BufferVectorType src_0_18 = svld1(pg, &src_row_18[0]);
    BufferVectorType src_1_18 = svld1_vnum(pg, &src_row_18[0], 1);
    BufferVectorType src_0_19 = svld1(pg, &src_row_19[0]);
    BufferVectorType src_1_19 = svld1_vnum(pg, &src_row_19[0], 1);
    BufferVectorType src_0_20 = svld1(pg, &src_row_20[0]);
    BufferVectorType src_1_20 = svld1_vnum(pg, &src_row_20[0], 1);
